...
const PORTALS = [
  {
    key: "voice",
    title: "Voice",
    desc: "Sign in with your Live Account — research-style auth, sessions on voice.phaosai.com.",
    // Hosted on www so we can match the Research auth UI; after login we hand the
    // shared-Supabase session off to voice.phaosai.com.
    href: "/auth?portal=voice&mode=signin",
    external: false,
    icon: Mic,
  },
  {
